...
Alternatively, if you have a Gu with the [**Deductive**] keyword you may use the **Deduction** action to improve the recipe, using your **Deduction** skill instead of **Refinement**. You must still meet the **Refinement** skill and attainment prerequisite.
