...
### Investigative
Most [**Investigative**] Gu are divinations that are used to detect your surroundings for creatures, Gu, or even specific objects. [**Investigative**] Gu can see through stealthing effects from Gu of a lower rank than themselves, including but not limited to invisibility, illusions, and obscuring effects (smoke). Some Gu with stealth effects will specify a different rank range of [**Investigative**] Gu that can see through their effect though, with that number taking priority. Dark Gu, for example, is strong enough that even [**Investigative**] Gu of one rank higher than itself cannot see through it.
