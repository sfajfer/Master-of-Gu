...
Alternatively, if you have a Gu with the [**Deductive**] keyword you may use the **Deduction** action to deduce the recipe, using your **Deduction** skill instead of **Refinement**. You still must meet the attainment requirements, and also must have a **Refinement** skill of {20, 30, 40, 60, 80} to attempt to create a recipe with the **Deduction** action. This process takes {4, 8, 12, 16, 20} hours to perform.
